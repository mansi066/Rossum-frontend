...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] xl:w-[90vw] aspect-square border border-n-2/5 rounded-[90%] -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      <Rings />
